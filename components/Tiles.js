...
const Tiles = ({ blok }) => {
  return (
    <div
      ...
      className="grid grid-cols-1 full-width-element no-padding-bottom lg:grid-cols-4 p-14 gap-20 mt-10 py-28 bg-[#F4E9E6] dark:bg-[#121212] text-[#25364F] dark:text-white"
    >
